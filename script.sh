...
if [ $question == "y" ]; then
  ...
  pacman -Syu -y
  pacman -S ghc picom patch make firefox xorg xorg-xrdb xterm polybar lightdm-gtk-greeter wget pulseaudio ttf-font-awesome alsa-utils lightdm htop nitrogen alacritty xmonad xmonad-contrib -y
